...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_0__.mapActions)("auth", ["sendLoginRequest"])), {}, {
    onSubmit: function onSubmit() {
      ...
      this.sendLoginRequest(this.details).then(function (res) {
        if (res.response !== undefined) {
          _this.$swal(res.response.data.message);

          return true;
        }

        _this.$swal(res.data.message);
      });
    }
  })
});
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Auth/Profile.vue?vue&type=script&lang=js&":
/*!*******************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Auth/Profile.vue?vue&type=script&lang=js& ***!
  \*******************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_0__.mapActions)("auth", ["sendRegisterRequest"])), {}, {
    onSubmit: function onSubmit() {
      ...
      this.sendRegisterRequest(this.user).then(function (res) {
        if (res.response !== undefined) {
          _this.$swal(res.response.data.message);
...
(0,vee_validate__WEBPACK_IMPORTED_MODULE_5__.extend)('required', _objectSpread(_objectSpread({}, vee_validate_dist_rules__WEBPACK_IMPORTED_MODULE_6__.required), {}, {
  message: 'This field is required.'
}));
(0,vee_validate__WEBPACK_IMPORTED_MODULE_5__.extend)('email', _objectSpread(_objectSpread({}, vee_validate_dist_rules__WEBPACK_IMPORTED_MODULE_6__.email), {}, {
  message: 'This field must be valid email.'
}));
(0,vee_validate__WEBPACK_IMPORTED_MODULE_5__.extend)('confirmed', _objectSpread(_objectSpread({}, vee_validate_dist_rules__WEBPACK_IMPORTED_MODULE_6__.confirmed), {}, {
  message: 'Password and Confirm password must be same.'
}));
(0,vee_validate__WEBPACK_IMPORTED_MODULE_5__.extend)('min', _objectSpread(_objectSpread({}, vee_validate_dist_rules__WEBPACK_IMPORTED_MODULE_6__.min), {}, {
  message: 'Minimum 5 characters required.'
}));
 // If you don't need the styles, do not connect


vue__WEBPACK_IMPORTED_MODULE_4__.default.use(vue_sweetalert2__WEBPACK_IMPORTED_MODULE_7__.default);
...
axios__WEBPACK_IMPORTED_MODULE_3___default().interceptors.response.use(function (response) {
  ...
  if (error.response.status === 422) {
    _store__WEBPACK_IMPORTED_MODULE_2__.default.commit("setErrors", error.response.data.errors);
  } else if (error.response.status === 401) {
    _store__WEBPACK_IMPORTED_MODULE_2__.default.commit("auth/setUserData", null);
...
/* harmony import */ var _components_Auth_Profile__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/Auth/Profile */ "./resources/js/components/Auth/Profile.vue");
...
/* harmony import */ var _components_NotFoundComponent__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/NotFoundComponent */ "./resources/js/components/NotFoundComponent.vue");
/* provided dependency */ var process = __webpack_require__(/*! process/browser */ "./node_modules/process/browser.js");
/**
...
var routes = [{
  ...
  name: "Profile",
  beforeEnter: auth,
  component: _components_Auth_Profile__WEBPACK_IMPORTED_MODULE_2__.default
}, {
  path: '*',
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  actions: {
    getUserData: function getUserData(_ref) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().get("http://dev.films-app.com/api" + "/user").then(function (response) {
    ...
    sendLoginRequest: function sendLoginRequest(_ref2, data) {
      ...
      return axios__WEBPACK_IMPORTED_MODULE_0___default().get('/sanctum/csrf-cookie').then(function (response) {
        return axios__WEBPACK_IMPORTED_MODULE_0___default().post("http://dev.films-app.com/api" + "/login", data).then(function (response) {
    ...
    sendRegisterRequest: function sendRegisterRequest(_ref3, data) {
      ...
      return axios__WEBPACK_IMPORTED_MODULE_0___default().post("http://dev.films-app.com/api" + "/register", data).then(function (response) {
        return response;
      })["catch"](function (error) {
        return error;
      });
    ...
    sendLogoutRequest: function sendLogoutRequest(_ref4) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().get("http://dev.films-app.com/api" + "/logout").then(function () {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Profile_vue_vue_type_template_id_09b0a70d___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Profile_vue_vue_type_template_id_09b0a70d___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Profile_vue_vue_type_template_id_09b0a70d___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Profile.vue?vue&type=template&id=09b0a70d& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Auth/Profile.vue?vue&type=template&id=09b0a70d&");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Verify_vue_vue_type_template_id_183c5476___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Verify_vue_vue_type_template_id_183c5476___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Verify_vue_vue_type_template_id_183c5476___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Verify.vue?vue&type=template&id=183c5476& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Auth/Verify.vue?vue&type=template&id=183c5476&");
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Auth/Profile.vue?vue&type=template&id=09b0a70d&":
/*!************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Auth/Profile.vue?vue&type=template&id=09b0a70d& ***!
  \************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
                      ...
                      [
                        ...
                        _c(
                          ...
                          [
                            ...
                            _c("validation-provider", {
                              attrs: {
                                rules: "required|confirmed:confirmation|min:5"
                              },
                              scopedSlots: _vm._u(
                                [
                                  {
                        ...
                        _c(
                          ...
                          [
                            ...
                            _vm._v(" "),
                            _c("validation-provider", {
                              attrs: { rules: "required", vid: "confirmation" },
                              scopedSlots: _vm._u(
                                [
                                  {
                                    key: "default",
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Auth/Verify.vue?vue&type=template&id=183c5476&":
/*!***********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Auth/Verify.vue?vue&type=template&id=183c5476& ***!
  \***********************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
